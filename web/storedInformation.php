...
<div class="bodyContent6">
  <?php
  foreach ($db->query('SELECT address_street, address_city, address_state, address_zip_code From address') as $row)
  {
    echo '<h2><b>' . 'Address: ' . $row['address_street'] . ' ' . $row['address_city'] . ' ' . $row['address_state'] . ' ' . $row['address_zip_code']  . '</b></h2>';
    // echo '<br/>';
  }
   ?>
